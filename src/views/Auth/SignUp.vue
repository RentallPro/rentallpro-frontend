    ...
    <div class="form-container">
      ...
      <div class="form-wrapper">
        ...
        <div class="input">
          ...
          <input type="text" v-model="form.firstName" class="input-box" />
        </div>
        <div class="input">
          <label for="Email">Last Name</label>
          <input type="text" v-model="form.lastName" class="input-box" />
        </div>
        <div class="input">
          <label for="Email">Email</label>
          <input type="email" v-model="form.email" class="input-box" />
        </div>
        <div class="input">
        ...
        <div class="input">
          ...
          <input v-model="form.phoneNumber" type="email" class="input-box" />
        </div>
        <button type="submit" @click="signup" class="login-button button">
          <span
            v-if="loading"
        ...
        <p class="option">
          ...
          <span><router-link :to="{ name: 'Home' }">Sign in</router-link></span>
        </p>
      </div>
    </div>
  </div>
