    ...
    <div class="form-container">
      ...
      <div class="form-wrapper">
        ...
        <div class="input">
          ...
          <div class="input-box">
            <input :type='passwordFieldType' v-model="password" class="password-input">
            <span @click="switchVisibility">{{ passwordFieldType === 'password' ? 'SHOW' : 'HIDE' }}</span>
          </div>
          <p><router-link :to="{name: 'ResetPassword'}">Forgot Password?</router-link></p>
        </div>
        ...
        <p class="option">Don’t have an account? <span><router-link :to="{name: 'SignUp'}">Create a new account</router-link></span></p>
      </div>
    </div>
  </div>
</template>
